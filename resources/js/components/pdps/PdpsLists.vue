...
<template>
    <div
        class="h-auto rounded-xl border border-sidebar-border/70 p-4 dark:border-sidebar-border"
    >
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="flex items-center gap-2">
                            ...
                            <span class="text-xs text-muted-foreground"
                                >{{ p.skills_count ?? 0 }} skills</span
                            >
                        </span>
                    </div>
                    <div class="text-xs text-muted-foreground">
                        {{ p.status }} · {{ p.priority
                        }}<span v-if="p.eta"> · ETA: {{ p.eta }}</span>
                    </div>
            ...
            <div class="mb-3 flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <button
                        class="rounded p-1 text-muted-foreground transition hover:bg-muted"
                        @click="
                            emit('update:collapseShared', !props.collapseShared)
                        "
