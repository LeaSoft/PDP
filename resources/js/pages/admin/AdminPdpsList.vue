...
function rowClass(r: Row) {
    if (r.pending_entries_count > 10) return 'bg-rose-50 dark:bg-rose-950/35';
    if (r.pending_entries_count > 0) return 'bg-amber-50 dark:bg-amber-950/30';
    return '';
}
</script>
